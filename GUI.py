...
def GUI():
    ...
    def y1DirPick():
        ...
        root.y1DirPath = tkFileDialog.askdirectory(initialdir="/home/melimat/Documents/CO2", title="Select directory")
        y1PathEntry.insert(10, root.y1DirPath)

    def y2DirPick():
        y2PathEntry.delete(0, "end")
        root.y2DirPath = tkFileDialog.askdirectory(initialdir="/home/melimat/Documents/CO2", title="Select directory")
    ...
    check = Checkbutton(root, text="Distinguish lines: ", variable=checkVar)
